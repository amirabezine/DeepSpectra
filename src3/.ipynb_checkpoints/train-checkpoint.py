...
class Trainer:
    ...
    def train_one_epoch(self, epoch, timing_data):
        ...
        for batch in train_bar:
            ...
            generated = self.generator(self.latent_codes[indices])
    ...
    def train_and_validate(self):
        ...
        for epoch in range(self.start_epoch, self.config.num_epochs):
            checkpoint_manager = CheckpointManager(self.config, self.generator, self.optimizer_g, self.optimizer_l, self.device, self.train_loader)
